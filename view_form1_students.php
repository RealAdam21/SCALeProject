...
<table border="1" width="783px">   
    ...
    <tr>
        <td colspan="4"><a href="insert_spearhead.php"><button type="button">ADD ACTIVITY</button></a></td>
    </tr>
	<tr>
        <td colspan="4"><a href="insert_spearhead_description.php"><button type="button">ADD ACTIVITY DESCRIPTION</button></a></td>
    </tr>
</table>
</form>
</body>
